...
abstract class BaseCustomerPeer
{
    ...
    const FIRSTNAME = 'customers.firstname';

    /** the column name for the lastname field */
    const LASTNAME = 'customers.lastname';

    /** the column name for the zip field */
    const ZIP = 'customers.zip';

    /** the column name for the city field */
    const CITY = 'customers.city';

    /** the column name for the country field */
    const COUNTRY = 'customers.country';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'Firstname', 'Lastname', 'Zip', 'City', 'Country', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'firstname', 'lastname', 'zip', 'city', 'country', ),
        BasePeer::TYPE_COLNAME => array (CustomerPeer::ID, CustomerPeer::FIRSTNAME, CustomerPeer::LASTNAME, CustomerPeer::ZIP, CustomerPeer::CITY, CustomerPeer::COUNTRY, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'FIRSTNAME', 'LASTNAME', 'ZIP', 'CITY', 'COUNTRY', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'firstname', 'lastname', 'zip', 'city', 'country', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Firstname' => 1, 'Lastname' => 2, 'Zip' => 3, 'City' => 4, 'Country' => 5, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'firstname' => 1, 'lastname' => 2, 'zip' => 3, 'city' => 4, 'country' => 5, ),
        BasePeer::TYPE_COLNAME => array (CustomerPeer::ID => 0, CustomerPeer::FIRSTNAME => 1, CustomerPeer::LASTNAME => 2, CustomerPeer::ZIP => 3, CustomerPeer::CITY => 4, CustomerPeer::COUNTRY => 5, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'FIRSTNAME' => 1, 'LASTNAME' => 2, 'ZIP' => 3, 'CITY' => 4, 'COUNTRY' => 5, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'firstname' => 1, 'lastname' => 2, 'zip' => 3, 'city' => 4, 'country' => 5, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
    );
