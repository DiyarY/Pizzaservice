...
abstract class BaseOrderPeer
{
    ...
    const COMPLETED_AT = 'orders.completed_at';
    ...
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'CustomersId', 'Total', 'CreatedAt', 'CompletedAt', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'customersId', 'total', 'createdAt', 'completedAt', ),
        BasePeer::TYPE_COLNAME => array (OrderPeer::ID, OrderPeer::CUSTOMERS_ID, OrderPeer::TOTAL, OrderPeer::CREATED_AT, OrderPeer::COMPLETED_AT, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'CUSTOMERS_ID', 'TOTAL', 'CREATED_AT', 'COMPLETED_AT', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'customers_id', 'total', 'created_at', 'completed_at', ),
    ...
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'CustomersId' => 1, 'Total' => 2, 'CreatedAt' => 3, 'CompletedAt' => 4, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'customersId' => 1, 'total' => 2, 'createdAt' => 3, 'completedAt' => 4, ),
        BasePeer::TYPE_COLNAME => array (OrderPeer::ID => 0, OrderPeer::CUSTOMERS_ID => 1, OrderPeer::TOTAL => 2, OrderPeer::CREATED_AT => 3, OrderPeer::COMPLETED_AT => 4, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'CUSTOMERS_ID' => 1, 'TOTAL' => 2, 'CREATED_AT' => 3, 'COMPLETED_AT' => 4, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'customers_id' => 1, 'total' => 2, 'created_at' => 3, 'completed_at' => 4, ),
        BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(OrderPeer::CUSTOMERS_ID);
            $criteria->addSelectColumn(OrderPeer::TOTAL);
            $criteria->addSelectColumn(OrderPeer::CREATED_AT);
            $criteria->addSelectColumn(OrderPeer::COMPLETED_AT);
        } else {
    ...
    public static function doCountJoinCustomer(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        ...
        $criteria->addJoin(OrderPeer::CUSTOMERS_ID, CustomerPeer::ID, $join_behavior);
